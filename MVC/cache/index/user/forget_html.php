...
<body>
    ...
    <div class="main">
        <div class="register-grids">
          	<div class="container">
					<form action="index.php?m=index&c=user&a=forget" method="post"> 
						<div class="register-top-grid">
							...
							<div>
								<span>邮箱验证码<label>*</label></span>
								<input type="text"> 
							</div> -->
							<div style="height:66.72px;width:425.3px;display:inline-block;">
								<input type="submit" value="发送动态密码" style="float:left; border-radius:4px;  background:#72D0f4;margin-top:6.5%;">
							</div>
							<div class="clear"> </div>
						</div>
					</form>
					<form action="index.php?m=index&c=user&a=forget" method="post"> 
						...
						<div class="register-bottom-grid">
							...
							<div style="height:66.72px;width:525.3px;">
								<img src="index.php?m=index&c=user&a=verify" style="margin-top:5%;"  onclick="this.src='index.php?m=index&c=user&a=verify&r='+Math.random();" />
							</div>
							<div class="clear"> </div>
						</div>
						<div class="clear"> </div>
