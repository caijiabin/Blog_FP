...
<body>
<form method="post" action="index.php?m=admin&c=article&a=recycle" id="listform">
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
	  ...
	  <?php if(!empty($relist)):?>
	  <?php foreach($relist as $key=>$value): ?>
        <tr>
          ...
          <td>
			<div class="button-group">
				<a class="button border-red" href="index.php?m=admin&c=article&a=recycle&id=<?=$value['id']; ?>" onclick=""><span class="icon-trash-o"></span> 恢复</a>
