...
<body>
<form method="post" action="index.php?m=admin&c=article&a=replylist" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 回复列表</strong> <a href="" style="float:right; display:none;"></a></div>
        ...
        <tr>
          ...
          <td>
			<div class="button-group">
				<a class="button border-red" href="index.php?m=admin&c=article&a=replylist&id=<?=$value['rid']; ?>" onclick=""><span class="icon-trash-o"></span> 回收</a>
